...
```javascript
chi = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-chi@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-array-chi/tags). For example,

```javascript
chi = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-chi@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-array-chi@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/random-array-chi/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/random-array-chi/actions/workflows/test.yml?query=branch:v0.2.0
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-array-chi.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-array-chi/main
